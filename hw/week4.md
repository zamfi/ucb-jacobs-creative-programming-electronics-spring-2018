### Homework 4 (due Tuesday, February 13, 2018)

This homework has three parts; first, with your group, extend the oscillator keyboard we looked at in class. Second, provide feedback to another group. Third, watch two tutorials by Daniel Shiffman about objects and arrays in preparation for Thursday's class.

Your group should submit a single [GitHub](http://github.com/zamfi/github-guide) repository with your work.
...
Your only brief for the project is: "make a visual musical instrument". Think outside the box. Don't just draw a piano on the canvas and play notes from keystrokes. That's a useful starting point, but the goal is to do something different, something novel, something that causes people to think at least a little bit.
...
These are some of the questions I want you to consider as you work on this project. Think of a few possible answers before diving in -- don't just run with the first idea that comes to mind.

##### Extending the Oscillator Keyboard

First, we'll start with some programming exercises to extend the oscillator code we examined at the end of class. Use the [alpha.editor.p5js.org](http://alpha.editor.p5js.org) to run code. Here's the initial code:
...
#### Tutorials (due before class on Thursday)
